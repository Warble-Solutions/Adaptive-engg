                ...
                <div className="w-full px-5 flex items-center justify-between h-24 relative">
                    ...
                    <Link href="/" className="z-20 mr-auto">
                        <Image
                            ...
                            width={240}
                            height={70}
                            className="h-20 w-auto object-contain opacity-100 transition-all duration-300 drop-shadow-[0_1px_3px_rgba(0,0,0,0.5)] drop-shadow-[0_4px_12px_rgba(0,0,0,0.25)]"
                            priority
                        />
                    </Link>
