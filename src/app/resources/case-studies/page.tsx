...
export default async function CaseStudiesPage() {
 ...
 className="group flex flex-col bg-white/5 backdrop-blur-xl border border-white/10 rounded-3xl overflow-hidden hover:border-primary/50 hover:shadow-xl shadow-2xl hover:bg-white/10 shadow-primary/20 transition-all duration-300"
 >
