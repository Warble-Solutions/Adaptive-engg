...
export default function CaseStudiesPageClient({ caseStudies }: { caseStudies: CaseStudy[] }) {
  ...
  // Define the 9 new case studies to place at the top
  ...
  // Combine static case studies (placed at top) with database case studies
  const allCaseStudies = [...staticCaseStudies, ...caseStudies];
