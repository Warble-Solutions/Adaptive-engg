...
export default function CertificationsPage() {
 ...
 <div className="bg-gradient-to-br from-teal-50 to-teal-50 rounded-3xl border border-teal-100 shadow-lg overflow-hidden group hover:border-primary/50 hover:shadow-xl shadow-2xl transition-shadow">
 ...
 {awards.map((award, i) => (
 <SectionWrapper key={i} delay={i * 0.1}>
 <div className="bg-slate-50 rounded-3xl border border-slate-100 shadow-lg overflow-hidden group hover:border-primary/50 hover:shadow-xl shadow-2xl transition-shadow">
