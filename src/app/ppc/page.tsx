...
export default function PPCPage() {
 ...
 <SectionWrapper key={i} delay={i * 0.1} className="h-full">
 <div className="flex items-center gap-4 p-6 bg-slate-50 rounded-xl border border-slate-100 hover:border-primary/50 hover:shadow-xl border-primary/30 transition-colors h-full">
