        ...
        <div className="max-w-7xl mx-auto px-6">
          <SectionWrapper>
            <div className="text-center mb-16">
              ...
              <h2 className="text-4xl md:text-5xl font-black text-white font-heading mb-6 tracking-tight">Platform <span className="gradient-heading">Features</span></h2>
            </div>
          </SectionWrapper>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <SectionWrapper delay={0.1}>
              <div className="p-8 bg-slate-900 rounded-3xl border border-white/10 hover:bg-[#0da08a] border-teal-500/50 transition-all duration-500 h-[350px] flex flex-col justify-end group relative overflow-hidden">
                <div className="absolute inset-0 bg-[url('/imgs/pm-kusum/kusum_telemetry_1776742420287.png')] bg-cover bg-center transition-transform duration-1000 group-hover:bg-[#0da08a] scale-105"></div>
            ...
            <SectionWrapper delay={0.2}>
              <div className="p-8 bg-slate-900 rounded-3xl border border-white/10 hover:bg-[#0da08a] border-teal-500/50 transition-all duration-500 h-[350px] flex flex-col justify-end group relative overflow-hidden">
                <div className="absolute inset-0 bg-[url('/imgs/pm-kusum/kusum_iot_scada_v2.png')] bg-cover bg-center transition-transform duration-1000 group-hover:bg-[#0da08a] scale-105"></div>
                <div className="absolute inset-0 bg-gradient-to-t from-[#0a1628] via-[#0a1628]/80 to-transparent"></div>
                <div className="relative z-10">
            ...
            <SectionWrapper delay={0.3}>
              <div className="p-8 bg-slate-900 rounded-3xl border border-white/10 hover:bg-[#0da08a] border-cyan-500/50 transition-all duration-500 h-[350px] flex flex-col justify-end group relative overflow-hidden">
                <div className="absolute inset-0 bg-[url('/imgs/pm-kusum/kusum_ams_1776742293340.png')] bg-cover bg-center transition-transform duration-1000 group-hover:bg-[#0da08a] scale-105"></div>
            ...
            <SectionWrapper delay={0.4}>
              <div className="p-8 bg-slate-900 rounded-3xl border border-white/10 hover:bg-[#0da08a] border-cyan-500/50 transition-all duration-500 h-[350px] flex flex-col justify-end group relative overflow-hidden">
                <div className="absolute inset-0 bg-[url('/imgs/pm-kusum/kusum_ht_panel_1776742333863.png')] bg-cover bg-center transition-transform duration-1000 group-hover:bg-[#0da08a] scale-105"></div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <SectionWrapper>
            <h2 className="text-3xl md:text-5xl font-black text-center mb-20 font-heading">
              Value <span className="gradient-heading">Creation</span>
            </h2>
          </SectionWrapper>
