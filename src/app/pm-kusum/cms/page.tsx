...
export default function Page() {
 ...
 <div className="p-8 bg-slate-900 rounded-3xl border border-white/10 hover:border-primary/50 hover:shadow-xl border-teal-500/50 transition-all duration-500 h-[350px] flex flex-col justify-end group relative overflow-hidden">
