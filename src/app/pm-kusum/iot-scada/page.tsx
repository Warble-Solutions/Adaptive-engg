...
export default function Page() {
 ...
 <div className="group relative p-10 bg-gradient-to-br from-slate-50 to-teal-50 rounded-3xl border border-teal-100 hover:border-primary/50 hover:shadow-xl shadow-2xl hover:border-primary/50 hover:shadow-xl -translate-y-2 transition-all duration-500 h-full overflow-hidden">
 ...
 <div className="group p-8 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 hover:border-primary/50 hover:shadow-xl border-primary/40 hover:bg-white/10 -translate-y-2 transition-all duration-300 h-full">
