...
export default function PmKusumPage() {
 ...
 <div className="dark-card p-8 bg-white/5 border border-white/10 rounded-2xl hover:border-primary/50 hover:shadow-xl hover:border-white/30 shadow-2xl transition-all duration-300 group cursor-default h-full flex flex-col items-start hover:-translate-y-2">
