        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <SectionWrapper delay={0}>
              <div className="p-8 rounded-2xl bg-slate-50 border border-slate-100 hover:border-primary/50 hover:shadow-xl shadow-md transition-all duration-300 group h-full">
            ...
            <SectionWrapper delay={0.1}>
              <div className="p-8 rounded-2xl bg-white border-2 border-primary/10 hover:border-primary/50 hover:shadow-xl shadow-md transition-all duration-300 group relative overflow-hidden h-full">
