...
export default function RenewablePage() {
 ...
 <div className="flex flex-col items-center text-center gap-6 mb-4">
 <div className="p-5 bg-teal-50 rounded-2xl text-[#0da08a] group-hover:border-primary/50 hover:shadow-xl group-hover:text-white transition-colors duration-300">
