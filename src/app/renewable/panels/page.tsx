...
export default function Page() {
 ...
 <img src="/images/renewable/hero-electrical-panels-v2.png" alt="Electrical Panels Background" className="w-full h-full object-cover" />
 ...
 <Link href="/pm-kusum/ht-panel" className="inline-flex items-center gap-2 px-6 py-3 border-2 border-slate-200 rounded-full font-bold text-sm text-slate-700 hover:border-primary/50 hover:shadow-xl border-primary hover:text-primary transition-all">
 HT Panels <ArrowRight className="w-4 h-4" />
 </Link>
 <Link href="/pm-kusum/acdb-panels" className="inline-flex items-center gap-2 px-6 py-3 border-2 border-slate-200 rounded-full font-bold text-sm text-slate-700 hover:border-primary/50 hover:shadow-xl border-primary hover:text-primary transition-all">
 ...
 <div className="group p-8 bg-white/5 border border-white/10 rounded-2xl hover:bg-white/10 hover:border-primary/50 hover:shadow-xl border-teal-500/30 hover:bg-white/10 -translate-y-2 transition-all duration-300 h-full">
 ...
 <div key={i} className="p-5 bg-white/5 border border-white/10 rounded-xl text-center hover:border-primary/50 hover:shadow-xl bg-teal-500/10 hover:bg-white/10 border-teal-500/30 transition-all">
