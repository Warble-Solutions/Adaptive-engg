...
export default function TurnkeyPage() {
 ...
 <Link href="/" className="hover:border-primary/50 hover:shadow-xl transition-colors">Home</Link>
 <ChevronRight className="w-4 h-4" />
 <Link href="/renewable" className="hover:border-primary/50 hover:shadow-xl transition-colors">Renewable</Link>
 <ChevronRight className="w-4 h-4" />
 ...
 <div className="absolute top-0 right-0 w-64 h-64 bg-teal-500/10 rounded-full blur-[80px] -mr-32 -mt-32 transition-colors duration-1000 group-hover:border-primary/50 hover:shadow-xl bg-teal-500/20"></div>
 ...
 <div className="p-10 bg-slate-50 border border-slate-100 rounded-[2rem] hover:border-primary/50 hover:shadow-xl border-teal-200 transition-colors duration-500 group">
 <div className="w-14 h-14 bg-white rounded-2xl flex items-center justify-center text-slate-800 mb-6 shadow-sm group-hover:border-primary/50 hover:shadow-xl bg-teal-50 group-hover:text-teal-600 transition-colors">
 ...
 <SectionWrapper delay={0.2}>
 <div className="p-10 bg-slate-900 rounded-3xl border border-white/10 hover:border-primary/50 hover:shadow-xl border-teal-500/50 transition-all duration-500 h-[400px] flex flex-col justify-between group relative overflow-hidden">
 ...
 {/* Bento Box 3 - Square */}
 <SectionWrapper delay={0.3}>
 <div className="p-10 bg-slate-900 rounded-3xl border border-white/10 hover:border-primary/50 hover:shadow-xl border-teal-500/50 transition-all duration-500 h-[350px] flex flex-col justify-between group relative overflow-hidden">
 <div className="relative z-10">
 <div className="w-12 h-12 bg-teal-500/20 rounded-2xl flex items-center justify-center text-teal-400 mb-6 group-hover:scale-110 transition-transform">
 ...
 <SectionWrapper delay={0.4}>
 <div className="md:col-span-2 p-10 bg-slate-900 rounded-3xl border border-white/10 hover:border-primary/50 hover:shadow-xl border-teal-500/50 transition-all duration-500 h-[350px] flex flex-col justify-end group relative overflow-hidden">
 <div className="absolute inset-0 bg-gradient-to-t from-[#0a1628] via-[#0a1628]/80 to-transparent"></div>
 <div className="absolute top-0 right-0 p-8 opacity-5 group-hover:opacity-10 transition-opacity">
