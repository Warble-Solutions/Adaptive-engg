  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(data.error || "Failed to upload case study");
      }
  ...
  return (
    <div className="max-w-2xl space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-white font-outfit">Upload Case Study</h1>
          <p className="text-gray-500 text-sm mt-0.5">Add a new case study PDF document</p>
        </div>
      </div>
        ...
        <div className="bg-gray-900/60 border border-white/10 rounded-2xl p-6 space-y-5">
          <div className="space-y-1.5">
            ...
            <input
              ...
              placeholder="e.g. 5MW Industrial Solar Microgrid Installation"
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              placeholder="Provide a short summary of the case study…"
