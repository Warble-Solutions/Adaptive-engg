      ...
      <section className="py-20 bg-white text-center relative z-20 rounded-t-[40px] -mt-10">
        <div className="max-w-2xl mx-auto px-6">
          <SectionWrapper>
            ...
            <Link href="/contact" className="inline-flex items-center gap-2 px-10 py-4 bg-gradient-to-r from-teal-500 to-teal-500 text-white rounded-full font-bold hover:bg-[#0da08a] shadow-lg transition-all hover:bg-slate-900 hover:text-white hover:scale-105">
