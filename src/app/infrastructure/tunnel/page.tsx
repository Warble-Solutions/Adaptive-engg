...
export default function Page() {
 ...
 <SectionWrapper>
 <div className="inline-block px-5 py-2.5 bg-teal-500/10 backdrop-blur-md text-teal-400 rounded-full text-xs font-bold uppercase tracking-widest mb-8 border border-teal-500/20 shadow-[0_0_30px_rgba(4,154,137,0.3)]">
 ...
 <p className="text-teal-400 font-bold tracking-wider uppercase text-sm block w-full text-center">
 ...
 <section className="py-16 bg-white rounded-t-[50px] relative z-20 -mt-20 border-t-4 border-teal-500 shadow-[0_-20px_50px_rgba(0,0,0,0.5)]">
 ...
 {stat.val}<span className="text-teal-500">{stat.suf}</span>
 </div>
 ...
 <div className="p-8 rounded-3xl border border-slate-100 bg-white shadow-sm transition-all duration-300 h-full flex flex-col group hover:-translate-y-1 hover:shadow-lg hover:border-primary/50 hover:shadow-xl border-teal-200">
 ...
 <div className="p-8 bg-white/5 backdrop-blur-md rounded-3xl border border-white/10 hover:bg-white/10 hover:bg-white/10 border-teal-500/50 transition-all duration-500 h-full flex flex-col group relative overflow-hidden">
 ...
 <div className="p-8 bg-gradient-to-br from-teal-500/10 to-teal-500/10 backdrop-blur-md rounded-3xl border border-teal-500/20 hover:border-primary/50 hover:shadow-xl bg-teal-500/20 transition-all duration-500 h-full flex flex-col items-center justify-center text-center group relative overflow-hidden">
 ...
 <p className="text-teal-300 font-bold text-sm leading-relaxed relative z-10">Highly Professional PMO Team.</p>
 </div>
 </SectionWrapper>
 </div>
 </div>
 ...
 <Link href="/contact" className="inline-flex items-center gap-2 px-10 py-4 bg-gradient-to-r from-teal-500 to-teal-500 text-white rounded-full font-bold hover:border-primary/50 hover:shadow-xl shadow-lg transition-all hover:bg-slate-900 hover:text-white hover:scale-105">
