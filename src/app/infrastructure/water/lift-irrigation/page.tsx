...
export default function Page() {
 ...
 <img src="/images/water/hero-lift-irrigation.png" alt="Large Scale Irrigation infrastructure" className="w-full h-full object-cover" />
 ...
 <div className="py-4">
 <div className="text-4xl font-black text-white mb-2">{WATER_STATS.irrigationPumpingStations.value}<span className="text-teal-500">{WATER_STATS.irrigationPumpingStations.suffix}</span></div>
 <p className="text-teal-400 text-sm font-bold uppercase tracking-wider">{WATER_STATS.irrigationPumpingStations.label}</p>
 </div>
 </SectionWrapper>
 ...
 <Handshake className="text-teal-600 w-5 h-5"/> Government Approved Partner
 </h3>
 ...
 <span key={i} className="px-3 py-1 bg-white border border-teal-200 text-teal-700 text-xs font-bold rounded-full">
 {agency}
 </span>
 ))}
 </div>
 ...
 <span className="text-teal-400 font-bold uppercase text-sm tracking-widest mb-2 block">Key Benefits</span>
