            ...
            <SectionWrapper delay={0.2}>
              <div className="space-y-8">
                ...
                <div className="relative rounded-[32px] overflow-hidden border border-white/10 shadow-2xl">
                  <Image src="/imgs/lift-irrigation-scada-telemetry.png" alt="High-capacity pumping station SCADA and asset tracking dashboard" width={800} height={500} className="w-full h-[320px] object-cover" />
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 to-transparent p-6">
                    <p className="text-white font-bold">Pumping Station SCADA & Asset Tracking</p>
                    <p className="text-gray-300 text-xs">Remote monitoring of high-capacity pumps, vibration sensors, and mobile asset management logs</p>
                  </div>
                </div>
