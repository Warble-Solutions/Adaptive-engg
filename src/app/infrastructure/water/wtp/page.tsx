...
export default function Page() {
  return (
    <div className="flex flex-col w-full">
      <SceneTrigger variant="logo" color="#0ea5e9" speed={0.5} />
      ...
      <section className="section-hero relative min-h-screen flex flex-col items-center justify-center text-center px-6 py-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-black/75 via-black/50 to-[#0f172a] z-10"></div>
        </div>
        <div className="z-10 max-w-7xl relative mx-auto flex flex-col items-center">
          <SectionWrapper>
            ...
            <Link href="/contact" className="inline-flex items-center gap-2 px-8 py-4 bg-sky-500 text-white rounded-full font-bold hover:bg-sky-400 transition-colors shadow-[0_0_20px_rgba(14,165,233,0.3)]">
      ...
      {/* STATS STRIP */}
      <section className="py-12 bg-[#081020] relative z-20 border-b border-sky-900/50">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center divide-y md:divide-y-0 md:divide-x divide-sky-900/50">
            <SectionWrapper delay={0.1}>
              <div className="py-4">
                <div className="text-4xl font-black text-white mb-2">{WATER_STATS.mldTreatedWater.value}<span className="text-sky-500">{WATER_STATS.mldTreatedWater.suffix}</span></div>
                <p className="text-sky-400 text-sm font-bold uppercase tracking-wider">{WATER_STATS.mldTreatedWater.label}</p>
              </div>
            </SectionWrapper>
            <SectionWrapper delay={0.2}>
              <div className="py-4">
                <div className="text-4xl font-black text-white mb-2">{WATER_STATS.supplySchemes.value}<span className="text-sky-500">{WATER_STATS.supplySchemes.suffix}</span></div>
                <p className="text-sky-400 text-sm font-bold uppercase tracking-wider">{WATER_STATS.supplySchemes.label}</p>
              </div>
            </SectionWrapper>
            <SectionWrapper delay={0.3}>
              <div className="py-4">
                <div className="text-4xl font-black text-white mb-2">1,500<span className="text-sky-500">{WATER_STATS.overheadTanks.suffix}</span></div>
                <p className="text-sky-400 text-sm font-bold uppercase tracking-wider">{WATER_STATS.overheadTanks.label}</p>
              </div>
            </SectionWrapper>
          </div>
        </div>
      ...
      <section className="py-24 bg-white relative z-20">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <SectionWrapper>
              <div>
                <span className="text-sky-500 font-bold uppercase text-sm tracking-widest mb-2 block">What We Deliver</span>
                ...
                <div className="space-y-6">
                  {[
                    ...
                    <div key={i} className="flex gap-4 p-5 rounded-2xl bg-slate-50 border border-slate-100 hover:border-sky-200 transition-colors">
                      <div className="mt-1">
            ...
            <SectionWrapper delay={0.2}>
              <div className="bg-sky-50 rounded-3xl p-8 border border-sky-100 sticky top-32">
                <h3 className="text-2xl font-bold text-slate-900 mb-6 font-heading border-b border-sky-200 pb-4">Key Benefits</h3>
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-4 font-heading mt-10 border-b border-sky-200 pb-4">Value Creation</h3>
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={i} className="flex items-start gap-3 text-slate-600 text-sm">
                      <LayoutTemplate className="w-5 h-5 text-sky-500 shrink-0 mt-0.5" />
                      {value}
                    </li>
                  ))}
                </ul>
