...
export default function Page() {
 ...
 <div key={i} className="flex gap-4 p-5 rounded-2xl bg-slate-50 border border-slate-100 hover:border-primary/50 hover:shadow-xl border-teal-200 transition-colors">
 <div className="mt-1">
