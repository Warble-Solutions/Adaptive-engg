...
export default function Page() {
  ...
  return (
    <div className="flex flex-col w-full text-slate-100">
      ...
      <section className="py-24 bg-white text-slate-900 relative z-20 rounded-t-[40px] -mt-4">
        <div className="max-w-7xl mx-auto px-6">
          
          {/* Row 1: Intro Text & Government Approvals vs SCADA Network Image */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center mb-16">
            {/* Left Column: Text & Government Approvals */}
            <div className="lg:col-span-7 space-y-6">
              <SectionWrapper>
                ...
                <h2 className="text-4xl md:text-5xl font-bold text-slate-900 font-heading leading-tight mb-6">
                  The Centralized SCADA Advantage
                </h2>
            ...
            {/* Right Column: Visual SCADA Network Image */}
            <div className="lg:col-span-5">
              <SectionWrapper delay={0.2}>
                <div className="relative rounded-[32px] overflow-hidden border border-slate-200 shadow-2xl">
                  <Image src="/imgs/central-scada-network.png" alt="Centralized SCADA telemetry network overview dashboard" width={800} height={500} className="w-full h-[360px] object-cover" />
          ...
          {/* Row 2: Grid of 8 Intelligence Features */}
