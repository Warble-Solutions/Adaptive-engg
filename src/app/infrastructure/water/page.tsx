...
export default function Page() {
  return (
    <div className="flex flex-col w-full">
      <SceneTrigger variant="logo" color="#0ea5e9" speed={0.5} /> {/* Sky blue for water */}
      ...
      <section className="section-hero relative min-h-screen flex flex-col items-center justify-center text-center px-6 py-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-black/70 via-black/40 to-[#0f172a] z-10"></div>
        </div>
        <div className="z-10 max-w-7xl relative">
          <SectionWrapper>
            <div className="inline-flex items-center gap-2 px-5 py-2.5 bg-sky-500/20 backdrop-blur-sm text-sky-400 rounded-full text-xs font-bold uppercase tracking-widest mb-8 border border-sky-500/30">
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <SectionWrapper delay={0.1}>
              <div className="p-8 bg-sky-50 border border-sky-100 rounded-3xl text-center h-full hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <div className="text-5xl font-black text-slate-900 mb-2">{WATER_STATS.yearsExperience.value}<span className="text-sky-500">{WATER_STATS.yearsExperience.suffix}</span></div>
                <p className="text-sm font-bold text-slate-500 uppercase tracking-wider">{WATER_STATS.yearsExperience.label}</p>
              </div>
            </SectionWrapper>
            <SectionWrapper delay={0.2}>
              <div className="p-8 bg-sky-50 border border-sky-100 rounded-3xl text-center h-full hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <div className="text-5xl font-black text-slate-900 mb-2">{WATER_STATS.mldTreatedWater.value}<span className="text-sky-500">{WATER_STATS.mldTreatedWater.suffix}</span></div>
                <p className="text-sm font-bold text-slate-500 uppercase tracking-wider">{WATER_STATS.mldTreatedWater.label}</p>
              </div>
            </SectionWrapper>
            <SectionWrapper delay={0.3}>
              <div className="p-8 bg-sky-50 border border-sky-100 rounded-3xl text-center h-full hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <div className="text-5xl font-black text-slate-900 mb-2">{WATER_STATS.supplySchemes.value}<span className="text-sky-500">{WATER_STATS.supplySchemes.suffix}</span></div>
                <p className="text-sm font-bold text-slate-500 uppercase tracking-wider">{WATER_STATS.supplySchemes.label}</p>
              </div>
            </SectionWrapper>
            <SectionWrapper delay={0.4}>
              <div className="p-8 bg-sky-50 border border-sky-100 rounded-3xl text-center h-full hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
                <div className="text-5xl font-black text-slate-900 mb-2">1,500<span className="text-sky-500">{WATER_STATS.overheadTanks.suffix}</span></div>
      ...
      <section className="py-24 bg-light relative z-20">
        <div className="max-w-7xl mx-auto px-6">
          <SectionWrapper>
            <div className="mb-16">
              <span className="text-sky-500 font-bold uppercase text-sm tracking-widest mb-2 block">Our Solutions</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <SectionWrapper delay={0.1}>
              <Link href="/infrastructure/water/wtp" className="block group h-full">
                <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm hover:shadow-xl hover:border-sky-200 transition-all duration-500 h-full flex flex-col justify-between">
                  <div>
                    ...
                    <h3 className="text-2xl font-bold text-slate-900 mb-3 font-heading group-hover:text-sky-600 transition-colors">Water Supply & WTP</h3>
                  ...
                  <div className="flex items-center text-sky-600 font-bold text-sm uppercase tracking-wider group-hover:gap-2 transition-all">
              ...
              <Link href="/infrastructure/water/stp" className="block group h-full">
                <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm hover:shadow-xl hover:border-sky-200 transition-all duration-500 h-full flex flex-col justify-between">
                  <div>
                    ...
                    <h3 className="text-2xl font-bold text-slate-900 mb-3 font-heading group-hover:text-sky-600 transition-colors">Sewage Treatment (STP)</h3>
              ...
              <Link href="/infrastructure/water/etp" className="block group h-full">
                <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm hover:shadow-xl hover:border-sky-200 transition-all duration-500 h-full flex flex-col justify-between">
                  <div>
                    ...
                    <h3 className="text-2xl font-bold text-slate-900 mb-3 font-heading group-hover:text-sky-600 transition-colors">Effluent Treatment (ETP)</h3>
              ...
              <Link href="/infrastructure/water/lift-irrigation" className="block group h-full">
                <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm hover:shadow-xl hover:border-sky-200 transition-all duration-500 h-full flex flex-col justify-between">
                  <div>
                    ...
                    <h3 className="text-2xl font-bold text-slate-900 mb-3 font-heading group-hover:text-sky-600 transition-colors">Lift Irrigation</h3>
              ...
              <Link href="/infrastructure/water/micro-irrigation" className="block group h-full">
                <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm hover:shadow-xl hover:border-sky-200 transition-all duration-500 h-full flex flex-col justify-between">
                  <div>
                    ...
                    <h3 className="text-2xl font-bold text-slate-900 mb-3 font-heading group-hover:text-sky-600 transition-colors">Micro Irrigation</h3>
            ...
            <SectionWrapper delay={0.6}>
              <Link href="/infrastructure/water/centralized-scada" className="block group h-full">
                <div className="bg-gradient-to-br from-sky-600 to-blue-800 rounded-3xl p-8 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 h-full flex flex-col justify-between overflow-hidden relative">
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-blue-100 leading-relaxed mb-6">Overall monitoring of quantitative and qualitative parameters with advanced data mining.</p>
                  </div>
      ...
      <section className="py-20 bg-transparent text-center relative z-10">
        <div className="max-w-2xl mx-auto px-6">
          <SectionWrapper>
            ...
            <Link href="/contact" className="inline-flex items-center gap-2 px-10 py-4 bg-sky-500 text-white rounded-full font-bold hover:bg-white hover:text-slate-900 transition-colors">
