...
export default function Page() {
  return (
    <div className="flex flex-col w-full">
      <SceneTrigger variant="logo" color="#049A89" speed={0.5} /> {/* Sky blue for water */}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <SectionWrapper delay={0.1}>
              <div className="p-8 bg-teal-50 border border-teal-100 rounded-3xl text-center h-full hover:shadow-xl transition-all duration-300 hover:-translate-y-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <SectionWrapper delay={0.1}>
              <Link href="/infrastructure/water/wtp" className="block group h-full">
                <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-sm hover:shadow-xl hover:border-teal-200 transition-all duration-500 h-full flex flex-col justify-between">
                  <div>
            ...
            <SectionWrapper delay={0.6}>
              <Link href="/infrastructure/water/centralized-scada" className="block group h-full">
                <div className="bg-gradient-to-br from-teal-600 to-teal-800 rounded-3xl p-8 shadow-xl hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 h-full flex flex-col justify-between overflow-hidden relative">
