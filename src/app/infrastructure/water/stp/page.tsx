...
export default function Page() {
 ...
 <img src="/images/water/hero-stp.png" alt="Sewage Treatment Plant" className="w-full h-full object-cover" />
 ...
 <div key={i} className="p-6 bg-slate-50 border border-slate-100 rounded-2xl hover:border-primary/50 hover:shadow-xl border-teal-200 transition-colors">
